                    ...
                    <div className="p-6">
                        ...
                        <div className="flex items-start gap-6">
                            <div className="relative">
                                <div className="w-24 h-24 rounded-full bg-blue-500 text-white text-2xl flex items-center justify-center font-medium">
                                    {profileData.avatar}
                                </div>
                        ...
                        {activeTab === 'overview' && (
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 leading-relaxed">{profileData.bio || 'No bio provided yet.'}</p>
                                </div>
                            </div>
                        )}
