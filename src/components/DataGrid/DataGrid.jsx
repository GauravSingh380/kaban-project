...
import { Search, Filter, Download, Eye, Edit, Trash2, Plus, ChevronLeft, ChevronRight, X, Calendar, Mail, Phone, MapPin, DollarSign } from 'lucide-react';
                ...
                <div className="p-6">
                    ...
                    {bugs.map((bug) => (
                        <BugCard
                            key={bug.id}
                            {...bug}
                            onView={(id) => console.log('View bug', id)}
                            onEdit={(id) => console.log('Edit bug', id)}
                            onDelete={(id) => console.log('Delete bug', id)}
                        />
                    ))}
                    {/* Pagination */}
